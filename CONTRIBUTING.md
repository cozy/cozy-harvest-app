# How to contribute to Cozy harvest-app?
...
- What is the version of the Cozy harvest-app app?
...
```
$ git clone github.com/cozy/cozy-harvest-app.git
$ cd cozy-harvest-app
$ git remote add fork git://github.com/yourusername/cozy-harvest-app.git
```
...
Go to https://github.com/yourusername/cozy-harvest-app and select your branch. Click the 'Pull Request' button and fill out the form.
...
The Cozy harvest-app is translated on a platform called [Transifex][tx]. [This tutorial][tx-start] can help you to learn how to make your first steps here. If you have any question, don't hesitate to ask us!
...
[issues]: https://github.com/cozy/cozy-harvest-app/issues/new
...
[localization]: https://github.com/cozy/cozy-harvest-app/blob/master/README.md#localization
