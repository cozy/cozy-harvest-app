[![Travis build status shield](https://img.shields.io/travis/cozy/cozy-harvest-app/master.svg)](https://travis-ci.org/cozy/cozy-harvest-app)
[![Github Release version shield](https://img.shields.io/github/tag/cozy/cozy-harvest-app.svg)](https://github.com/cozy/cozy-harvest-app/releases)
[![jest](https://facebook.github.io/jest/img/jest-badge.svg)](https://github.com/facebook/jest)


# Cozy harvest-app

## What's Cozy harvest-app?
...
Hacking the Cozy Cozy harvest-app app requires you to [setup a dev environment][setup].

You can then clone the app repository and install dependencies:

```sh
$ git clone https://github.com/cozy/cozy-harvest-app.git
$ cd cozy-harvest-app
$ yarn install
```
...
After the build and the docker image launched, your app is now available at http://cozy-harvest-app.cozy.tools:8080.
...
If you want to work on Cozy harvest-app and submit code modifications, feel free to open pull-requests! See the [contributing guide][contribute] for more information about how to properly open pull-requests.
...
The lead maintainer for Cozy harvest-app is [cozy](https://github.com/cozy), send him/her a :beers: to say hello!
...
Cozy harvest-app is developed by cozy and distributed under the [AGPL v3 license][agpl-3.0].
